...
export function Page2() {
    return (
        <div className="page2-skyline-container">
            ...
            />
            <img className="page2-madeinua-icon" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="100" src="./public/img/madeInUa.jpg" alt="Made in UA" />
            <img className="page2-bottom-image"  data-aos="fade-up-left" data-aos-duration= "1000"  src="./public/logo/UASkyline_logo8.png" alt="Logo" />
